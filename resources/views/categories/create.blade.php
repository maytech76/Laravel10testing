            ...
            <form class="max-w-lg mx-auto" action="{{route('categories.store')}}" method="POST">
               ...
               <div class="items-center gap-6">
                    ...
                    <a href="{{route('categories.index')}}">
                        <button 
                        class="text-gray-800 bg-red-200 hover:bg-red-400 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800">
                        Regresar</button>
                    </a>
                </div>
